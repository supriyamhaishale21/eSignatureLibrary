...
public class SigUtils
{
     ...
     */
    public static int getMDPPermission(@NonNull PDDocument doc)
    {
            ...
            throws CertificateParsingException
    {
        ...
        {
        	System.err.println("Certificate extended key usage does not include timeStamping");
        }
    }
            ...
            throws CertificateParsingException
    {
        ...
        {
        	System.err.println("Certificate extended key usage does not include OCSP responding");
        }
    }
